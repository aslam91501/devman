...
export const CreateFeatureModal = (props: Props) => {
    const title = 'Create Feature';
    ...
    type Schema = z.infer<typeof createFeatureSchema>;

    const { register, reset, handleSubmit, formState: { errors } } = useForm<Schema>({
        resolver: zodResolver(createFeatureSchema),
    })

    const { createFeature } = useFeatureMutation({ onClose, reset });
